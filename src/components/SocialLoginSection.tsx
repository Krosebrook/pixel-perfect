...
export function SocialLoginSection({ disabled = false, className = '' }: SocialLoginSectionProps) {
  ...
  return (
    ...
    >
      ...
      {/* Social Login Grid - 2x2 layout for cleaner look */}
      <div className="grid grid-cols-2 gap-3">
        {/* Google */}
        <Button
          type="button"
          variant="outline"
          className="h-11 gap-2 font-medium transition-all hover:bg-accent/50 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
        ...
        >
          ...
          <span className="sr-only sm:not-sr-only">Microsoft</span>
        </Button>
